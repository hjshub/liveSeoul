...
String zipFileFullPath = request.getParameter("zipFileFullPath");
...
} else if(zipFileFullPath != null && !"".equals(zipFileFullPath)){
...
try {
    ...
    if(zipFileFullPath != null && !"".equals(zipFileFullPath)){
    	file.delete();
    }
}
